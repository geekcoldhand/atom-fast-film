 ...
 *
 * The UI-facing single source of truth for the control set: default values,
 * tabs, and each slider's min/max/step + display label.
 *
 * Counterpart to rendering/constants.ts — anything the *UI* needs to know
 * about a slider lives here; anything the *paint math* needs to know lives
 * in rendering/constants.ts.
 */
